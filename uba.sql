...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2021 at 05:43 AM
...
(175, '6262339758', 'Savings', '2021-08-12', 18, 175, 1),
...
(175, 'Simphiwe', 'Mthanti', 'Flathela', '0724283941', 'admidfgdfn@fnb.com', '$2y$10$2lx0ckq1zQAAybtZx26dF.xl52xtB0HZh/u5opApjyTN6SpXzA6qG', 'North West', 2, '9602185854086'),
...
(107, 'Airtime from Account No 6262339758  Fnb to  Cell Phone 0658314141 MTN R20', 20, '6262339758', '2021-08-12'),
(108, 'Airtime from Account No 6262339758  Fnb to  Cell Phone 0613245242 MTN R12', 12, '6262339758', '2021-08-12'),
...
--
ALTER TABLE `account`
  MODIFY `acc_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=178;
...
--
ALTER TABLE `client`
  MODIFY `cli_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=178;

--
-- AUTO_INCREMENT for table `employee`
--
ALTER TABLE `employee`
  MODIFY `emp_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
