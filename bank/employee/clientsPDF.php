    ...
    if ($bankN == "Fnb")
    {
      ...
      class myPDF extends FPDF
      {
        ...
        function viewTable($conn,$emp_ID,$bank_ID)
        {
                ...
                $sql = "select c.cli_ID, c.cli_Name, c.cli_Surname,c.cli_Address, c.cli_Phone, c.cli_Email,b.bank_Name,a.acc_Number,a.acc_Type
    ...
    else if($bankN == "Capitec")
    {
                class myPDF extends FPDF
                {
                  ...
                  function viewTable($conn,$emp_ID,$bank_ID)
                  {
                          ...
                          $sql = "select c.cli_ID, c.cli_Name, c.cli_Surname,c.cli_Address, c.cli_Phone, c.cli_Email,b.bank_Name,a.acc_Number,a.acc_Type
                          				FROM  client c,bank b,branch br,account a,employee e
                          				WHERE e.emp_ID = '$emp_ID' AND b.bank_ID = '$bank_ID' AND br.branch_ID = b.branch_ID
                          				AND br.branch_Code = a.branch_Code AND a.cli_ID = c.cli_ID";
                          $result = mysqli_query($conn,$sql);
